...
int main() 
{
    ...
    int nodeValue, nodeHeight, levelValue, lessValue, greaterValue, removeKey, key;
    NODE* targetNode;
    ...
    do {
        ...
        cout << "7. Calculate the height of Binary Tree" << endl;
        ...
        cout << "14. Calculate the height of a NODE with given value" << endl;
        cout << "15. Calculate the level of a given NODE" << endl;
        cout << "16. Count the number leaves from a given Binary Tree" << endl;
        cout << "17. Count the number of NODE which key value is less than a given value" << endl;
        cout << "18. Count the number of NODE which key value is greater than a given value" << endl;
        ...
        switch (choice) {
            ...
            case 10:
                ...
                break;
            case 11:
                cout << "Enter the key of the node to remove: ";
                cin >> removeKey;
                cout << "After removing node with key: ";
                Remove(pRoot, removeKey);
                LevelOrder(pRoot);
                cout << endl;
                break;
            case 14:
                cout << "Enter the value of the node to get its height: ";
                cin >> nodeValue;
                nodeHeight = heightNode(pRoot, nodeValue);
                if (nodeHeight != -1)
                {
                    cout << "The height of NODE: " << nodeHeight << endl;
                }
                else
                {
                ...
                break;
            case 15:
                cout << "Enter the value of the node to get its level: ";
                cin >> levelValue;
                targetNode = Search(pRoot, levelValue);
                if (targetNode)
                {
            ...
            case 16:
                ...
                break;
            case 17:
                cout << "Enter the value to count nodes with key value less than: ";
                cin >> lessValue;
                cout << "Number of nodes with key value less than " << lessValue << ": " << countLess(pRoot, lessValue) << endl;
                break;
            case 18:
                cout << "Enter the value to count nodes with key value greater than: ";
                cin >> greaterValue;
                cout << "Number of nodes with key value greater than " << greaterValue << ": " << countGreater(pRoot, greaterValue) << endl;
                break;
            case 19:
                if (isBST(pRoot))
                {
    ...
    // Cleanup: Remove the entire tree
    removeTree(pRoot);
    return 0;
}